...
class AuthorStatisticsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_author_statistics, container, false)
        ...
        query.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (storySnapshot in dataSnapshot.children) {
                    ...
                    Glide.with(this@AuthorStatisticsFragment).load(coverUrl).into(coverImageView)
                    ...
                    storyLayout.setOnClickListener {
                        val intent = Intent(requireContext(), AuthorStatisticsActivity::class.java).apply {
